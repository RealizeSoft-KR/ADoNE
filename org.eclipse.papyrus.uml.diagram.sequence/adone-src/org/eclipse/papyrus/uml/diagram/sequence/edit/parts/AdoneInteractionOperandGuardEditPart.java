 ...
 *   RealizeSoft - Enhanced display of Interaction Operand's guard condition for clarity.
 *****************************************************************************/
...
import org.eclipse.papyrus.uml.diagram.sequence.figures.AdoneTopLevelLayerLabel;
...
/**
 * Extends the InteractionOperandGuardEditPart class to customize the appearance and behavior
 * of the guard condition on an Interaction Operand in sequence diagrams. This class specifically
 * overrides the figure creation method to adjust the Interaction Operand's constraint label to
 * the topmost layer, ensuring that the label's text is prominently displayed over other elements
 * in the diagram. The decision to closely replicate the source code from the superclass allows
 * for future modifications and enhancements while maintaining compatibility with existing features.
 */
public class AdoneInteractionOperandGuardEditPart extends InteractionOperandGuardEditPart {
	...
	public AdoneInteractionOperandGuardEditPart(View view) {
		super(view);
	}
	...
	public Command getCommand(Request request) {
		...
		// Return null for request type of REQ_OPEN to execute the InteractionConstraint input Dialog for Guard. (2024-02-01)
	...
	/**
	 * Overrides the method to set the Interaction Operand's constraint label to the topmost layer.
	 * This adjustment ensures that the text of the label appears at the topmost position in the diagram,
	 * enhancing visibility and readability. It is specifically tailored for the Interaction Operand's
	 * unique requirement to emphasize the constraint label over other diagram elements.
	 *
	 * @return The figure representing the label, adjusted for topmost layer visibility.
	 */
	@Override
	protected IFigure createFigure() {
		InteractionOperandEditPart operandEp = (InteractionOperandEditPart) getParent();
		View operandView = operandEp.getPrimaryView();
		AdoneTopLevelLayerLabel label = new AdoneTopLevelLayerLabel(operandView);
		AdoneInteractionOperandFigure fig = (AdoneInteractionOperandFigure) ((AdoneInteractionOperandEditPart) getParent()).getPrimaryShape();
		fig.setfInteractionConstraintLabel(label);
		fig.repaint();
