...
/**
 * This class is an extension of the UpdateConnectionReferenceEditPolicy, specifically tailored for updating connection references within Papyrus diagrams.
 * It is currently marked for further review and is slated for potential deletion. The policy aims to address specific scenarios
 * related to the reconnection of source and target elements in diagrams, facilitating accurate representation and manipulation
 * of connections. However, given its specialized nature, its overall utility within the broader framework is under evaluation
 * to determine its necessity and effectiveness. Pending this review, the class may be deprecated to streamline the edit policy suite.
 */
// public class AdoneUpdateConnectionReferenceEditPolicy extends UpdateConnectionReferenceEditPolicy {
public class AdoneUpdateConnectionReferenceEditPolicy extends GraphicalEditPolicy {
	 ...
	 *         <UL>
	 *
	 *         아래 메소드는 BES 을 선택하고 이동 시 BES의 시작 메시지와 BES 의 자식 BES 를 이동시키는 Request 를 생성힌다 (2023-11-24)
	 *
	 */
	@Override
