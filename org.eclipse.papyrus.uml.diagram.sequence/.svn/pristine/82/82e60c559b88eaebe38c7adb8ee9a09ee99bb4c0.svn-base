 ...
 *   RealizeSoft - added NPE handling code.
 *****************************************************************************/
...
/**
 * Copies original source code and adds null pointer exception (NPE) prevention code to enhance stability
 * and prevent crashes during model editing operations.
 */
public class AdoneCustomExecutionSpecificationCreationEditPolicy extends DefaultCreationEditPolicy {

	private DisplayEvent displayEvent;

	public AdoneCustomExecutionSpecificationCreationEditPolicy() {
		super();
	}
	...
	public EditPart getTargetEditPart(Request request) {
		...
		if (elementTypes != null) {
			...
			Optional<EClass> interestingType = elementTypes.map(type -> {
				...
				// }).findFirst();
				// add NPE handlling code (2023-12-01)
